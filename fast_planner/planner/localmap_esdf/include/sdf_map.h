...
public:
  ...
  void startUpdateMapInfo(Eigen::Vector3d robot_po);

  void updateMapOrigin(Eigen::Vector3d robot_pos);

  void updateMapRolling(Eigen::Vector3d robot_pos);

  void getObstacleWorldPoints(std::vector<Eigen::Vector3d>& points);
